...
const DEFAULT_MARQUEE_SPEED = 54;
const HOVER_MARQUEE_SPEED = 34;
...
export function CertificatesSection({ items }: CertificatesSectionProps) {
  ...
  return (
    <section ref={sectionRef} className={styles.section} id="certificates">
        ...
        >
          <div ref={railTrackRef} className={styles.railTrack}>
            <div ref={railGroupRef} className={styles.railGroup}>
              {items.map((item) => (
                <article key={`primary-${item.label}`} className={styles.card}>
            ...
            <div aria-hidden="true" className={`${styles.railGroup} ${styles.railGroupDuplicate}`}>
              {items.map((item) => (
                <article key={`duplicate-${item.label}`} className={styles.card}>
                  <div className={styles.imageWrap}>
                    <Image
                      alt=""
                      className={styles.image}
