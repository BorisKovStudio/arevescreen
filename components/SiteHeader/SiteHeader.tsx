...
function PhoneIcon({ className }: IconProps) {
  return (
    <svg aria-hidden="true" className={className} viewBox="0 0 24 24">
      <path d="M6.6 10.8c1.8 3.5 3.1 4.8 6.6 6.6l2.2-2.2c0.3-0.3 0.8-0.4 1.2-0.3 1.2 0.4 2.4 0.7 3.7 0.7 0.6 0 1.1 0.5 1.1 1.1V21c0 0.6-0.5 1.1-1.1 1.1C10 22.1 1.9 14 1.9 3.8 1.9 3.2 2.4 2.7 3 2.7h4.3c0.6 0 1.1 0.5 1.1 1.1 0 1.3 0.2 2.5 0.7 3.7 0.1 0.4 0 0.9-0.3 1.2z" />
    </svg>
  );
}
...
function MailIcon({ className }: IconProps) {
  return (
    <svg aria-hidden="true" className={className} viewBox="0 0 24 24">
      <path d="M3 5.2h18c0.6 0 1 0.4 1 1v11.6c0 0.6-0.4 1-1 1H3c-0.6 0-1-0.4-1-1V6.2c0-0.6 0.4-1 1-1zm0.8 1.9L12 12.9l8.2-5.8H3.8zm17.2 9.8V8.3l-8.4 5.9c-0.3 0.2-0.8 0.2-1.1 0L3 8.3v8.6h18z" />
    </svg>
  );
}
...
function YelpIcon({ className }: IconProps) {
  return (
...
export function SiteHeader({ navigation: _navigation, socialLinks, phone, email }: SiteHeaderProps) {
  return (
